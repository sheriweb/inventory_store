                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 digital-add needs-validation">
                                    <div class="form-group">
                                        ...
                                        <input name="sku" class="form-control" value="{{ @$product['sku'] }}"
                                               id="validationCustomtitle" type="text"
                                               required="">
                                ...
                                <div class="col-md-6 digital-add needs-validation">
                                    <div class="form-group">
                                        <label for="validationCustomtitle" class="col-form-label pt-0"><span>*</span>
                                            New Quantity</label>
                                        <input name="quantity" class="form-control" id="validationCustomtitle"
                                               type="number"
                                ...
                                <div class="col-md-6 digital-add needs-validation">
                                    <div class="form-group">
                                        ...
                                        <input name="refurbished_quantity" class="form-control"
                                               id="validationCustomtitle" type="number"
                                ...
                                <div class="col-md-6 digital-add needs-validation">
                                    <div class="form-group">
                                        ...
                                        <input name="brand" class="form-control" id="product_brand" type="text"
                                               value="{{ @$product['brand'] }}">
                                ...
                                <div class="col-md-6 digital-add needs-validation">
                                    <div class="form-group">
                                        <label for="validationCustom02" class="col-form-label pt-0"><span>*</span>
                                            Weight </label>
                                        <input class="form-control" value="{{ @$product['weight'] }}" name="weight"
                                               id="retail_weight" type="text">
                                ...
                                <div class="col-md-6 digital-add needs-validation">
                                    <div class="form-group">
                                        <label for="validationCustom02" class="col-form-label  pt-0"><span>*</span>
                                            Dimensions </label>
                                        <input class="form-control" value="{{ @$product['dimensions'] }}"
                                               name="dimensions" id="dimensions" type="text">
                                                ...
                                                @foreach($product['images'] as $key => $image)
                                                    <div class="upload__img-box">
                                                        <div
                                                            ...
                                                            data-id="{{$image['id']}}" data-file="{{ $image['name'] }}"
                            ...
                            <div class="row">
                                <div class="col-md-6 digital-add needs-validation">
                                    <div class="form-group">
                                        <label for="validationCustom02" class="col-form-label"><span>*</span> New
                                            Price</label>
                                        <input name="price" class="form-control" id="product_price" type="text"
                                               value="{{ @$product['price'] }}">
                                ...
                                <div class="col-md-6 digital-add needs-validation">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" value="{{ @$product['retail_price'] }}"
                                               name="retail_price" id="retail_price" type="text">
                                        <span class="error_retail_price text-danger"></span>
                                    </div>
                                </div>
                                <div class="col-md-6 digital-add needs-validation">
                                    <div class="form-group">
                                        <label for="validationCustom02" class="col-form-label">Refurbished
                                            Price </label>
                                        <input class="form-control" value="{{ @$product['refurbished_price'] }}"
                                               name="refurbished_price" id="refurbished_price" type="text">
                                        <span class="error_refurbished_price text-danger"></span>
                                    </div>
                                </div>
                                <div class="col-md-6 digital-add needs-validation">
                                    <div class="form-group">
                                        <label for="validationCustom02" class="col-form-label"> Sale Refurbished
                                            Price </label>
                                        <input class="form-control" value="{{ @$product['sale_refurbished_price'] }}"
                                               name="sale_refurbished_price" id="sale_refurbished_price"
                                               type="text">
                            ...
                            <div class="row">
                                <div class="col-md-6 digital-add needs-validation">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" value="{{ @$product['capacity'] }}" name="capacity"
                                               id="capacity" type="text">
                                        <span class="error_capacity text-danger"></span>
                                    </div>
                                </div>
                                <div class="col-md-6 digital-add needs-validation">
                                    <div class="form-group">
                                        <label for="validationCustom02" class="col-form-label"> Capacity
                                            (Watts) </label>
                                        <input class="form-control" value="{{ @$product['capacity_watts'] }}"
                                               name="capacity_watts" id="capacity_watts" type="text">
                                        <span class="error_capacity_watts text-danger"></span>
                                    </div>
                                </div>
                                <div class="col-md-6 digital-add needs-validation">
                                    <div class="form-group">
                                        <label for="validationCustom02" class="col-form-label"> Processing
                                            Speed </label>
                                        <input class="form-control" value="{{ @$product['processing_speed'] }}"
                                               name="processing_speed" id="processing_speed" type="text">
                                ...
                                <div class="col-md-6 digital-add needs-validation">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" value="{{ @$product['screen_size'] }}"
                                               name="screen_size" id="screen_size" type="text">
                                ...
                                <div class="col-md-6 digital-add needs-validation">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" value="{{ @$product['storage'] }}" name="storage"
                                ...
                                <div class="col-md-6 digital-add needs-validation">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" value="{{ @$product['no_of_ports'] }}"
                                               name="no_of_ports" id="no_of_ports" type="text">
                                ...
                                <div class="col-md-6 digital-add needs-validation">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" value="{{ @$product['technology'] }}"
                                               name="technology" id="technology" type="text">
                                ...
                                <div class="col-md-6 digital-add needs-validation">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" value="{{ @$product['form_factor'] }}"
                                               name="form_factor" id="form_factor" type="text">
                                ...
                                <div class="col-md-6 digital-add needs-validation">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" value="{{ @$product['memory'] }}" name="memory"
                                               id="memory" type="text">
                                ...
                                <div class="col-md-6 digital-add needs-validation">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" value="{{ @$product['generation'] }}"
                                ...
                                <div class="col-md-6 digital-add needs-validation">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" value="{{ @$product['product_type'] }}"
                                               name="product_type" id="product_type" type="text">
                                ...
                                <div class="col-md-6 digital-add needs-validation">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" value="{{ @$product['cache_type'] }}"
                                               name="cache_type" id="cache_type" type="text">
                                        <span class="error_cache_type text-danger"></span>
                                    </div>
                                </div>
                                <div class="col-md-6 digital-add needs-validation">
                                    <div class="form-group">
                                        <label for="validationCustom02" class="col-form-label"> Screen
                                            Resolution </label>
                                        <input class="form-control" value="{{ @$product['screen_resolution'] }}"
                                               name="screen_resolution" id="screen_resolution" type="text">
