        ...
        <div class="main-header-right ">
            ...
            <div class="nav-right col">
                <ul class="nav-menus">
                    ...
                    {{--                            <li>--}}
                    {{--                                <div class="media">--}}
                    {{--                                    <div class="notification-icons bg-info me-3"><i data-feather="message-circle"></i>--}}
                    {{--                                    </div>--}}
                    {{--                                    <div class="media-body">--}}
                    ...
                    {{--                            <li>--}}
                    {{--                                <div class="media">--}}
                    {{--                                    <div class="notification-icons bg-secondary me-3"><i data-feather="download"></i>--}}
                    {{--                                    </div>--}}
                    {{--                                    <div class="media-body">--}}
                    ...
                    {{--                            <li class="bg-light txt-dark"><a href="javascript:void(0)" data-original-title="" title="">All </a>--}}
                    {{--                                notification--}}
                    {{--                            </li>--}}
                    {{--                        </ul>--}}
                    {{--                    </li>--}}
                    {{--                    <li><a href="javascript:void(0)">--}}
                    {{--                            <i class="right_side_toggle"--}}
                    {{--                                                        data-feather="message-square"></i><span class="dot"></span></a>--}}
                    </li>
                    <li class="onhover-dropdown">
        ...
        <div class="page-sidebar">
            <div class="sidebar custom-scrollbar">
                <div class="sidebar-user text-center">
                    <div><img class="img-60 rounded-circle lazyloaded blur-up" src="{{asset('assets/images/layout-2/logo/shop-pemeaumn1.jpg')}}"
                              alt="#">
                    </div>
                    <br>
                    <p>Shop Premium</p>
