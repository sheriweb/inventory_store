            ...
            <div class="panel panel-default credit-card-box">
                ...
                <div class="panel-body">
                    ...
                    @endif
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <button class="btn btn-primary btn-lg btn-block" type="submit">Pay Now ({{ \App\Services\theme\HomeService::$currencyFormat }} {{ \App\Services\ConstantService::moneyFormat( $amount) }})</button>
                            </div>
                        </div>
