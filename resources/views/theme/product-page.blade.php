                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="product-slick">
                                        <div><img src="{{ $product['thumbnail_image'] }}" alt="" class="img-fluid  image_zoom_cls-0"></div>
                                        @foreach($product['files'] as $image)
                                        <div><img src="{{ $image->image_url }}" alt="" class="img-fluid  image_zoom_cls-0"></div>
                                        @endforeach
                                    </div>
                                    <div class="row">
                                        <div class="col-12 p-0">
                                            <div class="slider-nav">
                                                <div><img src="{{ $product['thumbnail_image'] }}" alt="" class="img-fluid  image_zoom_cls-0"></div>
                                                @foreach($product['files'] as $image)
                                                    @if($image->file_type != 'imageThumbnail')
                                                <div><img src="{{ $image->image_url }}" alt="" class="img-fluid  image_zoom_cls-0"></div>
                                                    @endif
                                                @endforeach
                                            </div>
                                ...
                                <div class="col-lg-6 rtl-text">
                                    <div class="product-right">
                                        <div class="pro-group">
                                            ...
                                            @if(@$product['price'] > 0)
                                            <ul class="pro-price">
                                                <li class="price_style">@if($product['refurbished_price'] > 0)New @endif  Price</li>
                                                <li class="price_number"> {{ \App\Services\theme\HomeService::$currencyFormat }} {{ $product['price'] }} </li>
                                                <li  class="price_number"><span>mrp {{ \App\Services\theme\HomeService::$currencyFormat }} {{$product['retail_price']}}</span></li>
                                                <li  class="price_number">{{ \App\Services\theme\HomeService::calculatePriceDifference($product['price'],$product['retail_price']) }} @if($product['retail_price'] > $product['price']) off @else Increase @endif</li>
                                            </ul>
                                            @endif
                                            @if(@$product['refurbished_price'] > 0)
                                                <ul class="pro-price">
                                                    <li class="price_style">Refurbished Price</li>
                                                    <li class="price_number"> {{ \App\Services\theme\HomeService::$currencyFormat }} {{ $product['refurbished_price'] }} </li>
                                                    <li class="price_number"><span>mrp {{ \App\Services\theme\HomeService::$currencyFormat }} {{$product['sale_refurbished_price']}}</span></li>
                                                    <li class="price_number" >{{ \App\Services\theme\HomeService::calculatePriceDifference($product['refurbished_price'],$product['sale_refurbished_price']) }} @if($product['sale_refurbished_price'] > $product['refurbished_price']) off @else Increase @endif</li>
                                                </ul>
                                            @endif
                                                ...
                                                <div class="qty_div">
                                                    <div class="qty-box">
                                                        <div class="input-group">
                                                            ...
                                                            <input class="qty-adj product-qty form-control" type="number" value="1"/>
                                                            <button class="qty-plus"></button>
                                                        </div>
                                                    </div>
                                                    @if($product['quantity'] == 0 && $product['refurbished_quantity'] == 0)
                                                    <div class="out_of_stock text-danger">Out of stock</div>
                                                    @endif
                                                </div>

                                                <div class="product-buttons">
                                                    <a href="javascript:void(0)"  id="cartEffect" product_id="{{$product['id']}}" product_type="{{ $product['productType'] }}" product_price="{{$product['price']}}" refurbished_price="{{$product['refurbished_price']}}" qty=""
                                                       class="btn cart-btn btn-normal tooltip-top  @if($product['quantity'] == 0 && $product['refurbished_quantity'] == 0) out_of_stock_qty @endif " data-tippy-content="Add to cart">
                                        ...
                                        <div class="pro-group">
                                            ...
                                            <div class="row">
                                                @if($product['brand'] != null)
                                                    <div class="col-md-6">
                                                        <span class="attribute_name text-black ">Brand : </span>
                                                        <span class="attribute_value"> {{ @$product['brand'] }}</span>
                                                    </div>
                                                @endif
                                                @if($product['weight'] != null)
                                                    <div class="col-md-6">
                                                        <span class="attribute_name text-black ">Weight : </span>
                                                        <span class="attribute_value"> {{ @$product['weight'] }}</span>
                                                    </div>
                                                @endif
                                                @if($product['dimensions'] != null)
                                                    <div class="col-md-6">
                                                        <span class="attribute_name text-black ">Dimensions : </span>
                                                        <span class="attribute_value"> {{ @$product['dimensions'] }}</span>
                                                    </div>
                                                @endif
                                                @if($product['capacity'] != null)
                                                    <div class="col-md-6">
                                                        <span class="attribute_name text-black ">Capacity : </span>
                                                        <span class="attribute_value"> {{ @$product['capacity'] }}</span>
                                                    </div>
                                                @endif
                                                @if($product['capacity_watts'] != null)
                                                    <div class="col-md-6">
                                                        <span class="attribute_name text-black ">Capacity Watts : </span>
                                                        <span class="attribute_value"> {{ @$product['capacity_watts'] }}</span>
                                                    </div>
                                                @endif
                                                @if($product['technology'] != null)
                                                    <div class="col-md-6">
                                                        <span class="attribute_name text-black ">Technology : </span>
                                                        <span class="attribute_value"> {{ @$product['technology'] }}</span>
                                                    </div>
                                                @endif
                                                @if($product['capacity'] != null)
                                                    <div class="col-md-6">
                                                        <span class="attribute_name text-black ">Processing Speed : </span>
                                                        <span class="attribute_value"> {{ @$product['processing_speed'] }}</span>
                                                    </div>
                                                @endif
                                                @if($product['no_of_ports'] != null)
                                                    <div class="col-md-6">
                                                        <span class="attribute_name text-black ">No Of Ports : </span>
                                                        <span class="attribute_value"> {{ @$product['no_of_ports'] }}</span>
                                                    </div>
                                                @endif
                                                @if($product['capacity'] != null)
                                                    <div class="col-md-6">
                                                ...
                                                @if($product['memory'] != null)
                                                    <div class="col-md-6">
                                                        <span class="attribute_name text-black ">Memory : </span>
                                                        <span class="attribute_value"> {{ @$product['memory'] }}</span>
                                                    </div>
                                                @endif
                                                @if($product['storage'] != null)
                                                    <div class="col-md-6">
                                                        <span class="attribute_name text-black ">Storage : </span>
                                                        <span class="attribute_value"> {{ @$product['storage'] }}</span>
                                                    </div>
                                                @endif
                                                @if($product['screen_size'] != null)
                                                    <div class="col-md-6">
                                                        <span class="attribute_name text-black ">Screen Size : </span>
                                                        <span class="attribute_value"> {{ @$product['screen_size'] }}</span>
                                                    </div>
                                                @endif
                                                @if($product['screen_resolution'] != null)
                                                    <div class="col-md-6">
                                                        <span class="attribute_name text-black ">Screen Resolution  : </span>
                                                        <span class="attribute_value"> {{ @$product['screen_resolution'] }}</span>
                                                    </div>
                                                @endif
                                                @if($product['cache_type'] != null)
                                                    <div class="col-md-6">
                                                        <span class="attribute_name text-black ">Cache Type  : </span>
                                                        <span class="attribute_value"> {{ @$product['cache_type'] }}</span>
                                                    </div>
                                                @endif
                                                @if($product['product_type'] != null)
                                                    <div class="col-md-6">
                                                        <span class="attribute_name text-black ">Product Type  : </span>
                                                        <span class="attribute_value"> {{ @$product['product_type'] }}</span>
                                                    </div>
                                                @endif
                                                @if($product['generation'] != null)
                                                    <div class="col-md-6">
                                                        <span class="attribute_name text-black ">Generation  : </span>
                                                        <span class="attribute_value"> {{ @$product['generation'] }}</span>
                                                    </div>
                                                @endif
                                                @if($product['form_factor'] != null)
                                                    <div class="col-md-6">
                                                        <span class="attribute_name text-black ">Form Factor  : </span>
                                                        <span class="attribute_value"> {{ @$product['form_factor'] }}</span>
                                                    </div>
                                                @endif
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-12 col-lg-12">
                                    <div class="creative-card creative-inner">
                                        <ul class="nav nav-tabs nav-material" id="top-tab" role="tablist">
                                            <li class="nav-item"><a class="nav-link active bg-transparent" id="top-home-tab" data-bs-toggle="tab" href="#top-home" role="tab" aria-selected="true"><i class="icofont icofont-ui-home"></i>Specification</a>
                                                <div class="material-border"></div>
                                            </li>
                                            <li class="nav-item"><a class="nav-link bg-transparent" id="profile-top-tab" data-bs-toggle="tab" href="#top-profile" role="tab" aria-selected="false"><i class="icofont icofont-man-in-glasses"></i>Description</a>
                                                <div class="material-border"></div>
                                            </li>
                                            <li class="nav-item"><a class="nav-link bg-transparent" id="contact-top-tab" data-bs-toggle="tab" href="#top-contact" role="tab" aria-selected="false"><i class="icofont icofont-contacts"></i>Read Before Order</a>
                                                <div class="material-border"></div>
                                            </li>
{{--                                            <li class="nav-item"><a class="nav-link bg-transparent" id="review-top-tab" data-bs-toggle="tab" href="#top-review" role="tab" aria-selected="false"><i class="icofont icofont-contacts"></i>Write Review</a>--}}
                                                <div class="material-border"></div>
                                            </li>
                                        </ul>
...
@section('script')
    ...
    <script>
        $(document).on('click','.cart-btn', function (){
           ...
           let product_type = $(this).attr('product_type');
           let refurbished_price = $(this).attr('refurbished_price');
           let qty = $('.product-qty').val();
            addToCart(product_id,product_type,qty,product_price,refurbished_price);
        })
    </script>
