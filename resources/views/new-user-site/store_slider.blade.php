                                ...
                                <ul class="top-parent-ul-items">
                                    ...
                                    <li class="all-brand-card">
                                        ...
                                        <div class="logo-barnd-img">
                                            <img class="img-fluid"
                                                 src="{{asset('new-user-side/images/brand-logo-1.png')}}" alt="img">
                                        </div>
                                    </li>
                                    <li class="all-brand-card">
                                        <div class="all-brand-img">
                                            <img class="img-fluid"
                                                 src="{{asset('new-user-side/images/brand-2.jpg')}}" alt="img">
                                        </div>
                                        <div class="overlay-brand">
                                        ...
                                        <div class="logo-barnd-img">
                                            <img class="img-fluid"
                                                 src="{{asset('new-user-side/images/brand-logo-2.png')}}" alt="img">
                                        </div>
                                    </li>
                                    <li class="all-brand-card">
                                        <div class="all-brand-img">
                                            <img class="img-fluid"
                                                 src="{{asset('new-user-side/images/brand-3.jpg')}}" alt="img">
                                        </div>
                                        <div class="overlay-brand">
                                        ...
                                        <div class="logo-barnd-img">
                                            <img class="img-fluid"
                                                 src="{{asset('new-user-side/images/brand-logo-3.png')}}" alt="img">
                                        </div>
                                    </li>
                                    <li class="all-brand-card">
                                        <div class="all-brand-img">
                                            <img class="img-fluid"
                                                 src="{{asset('new-user-side/images/brand-4.jpg')}}" alt="img">
                                        </div>
                                        <div class="overlay-brand">
                                        ...
                                        <div class="logo-barnd-img">
                                            <img class="img-fluid"
                                                 src="{{asset('new-user-side/images/brand-logo-4.png')}}" alt="img">
                                        </div>
                                    </li>
                                    <li class="all-brand-card">
                                        <div class="all-brand-img">
                                            <img class="img-fluid"
                                                 src="{{asset('new-user-side/images/brand-5.jpg')}}" alt="img">
                                        </div>
                                        <div class="overlay-brand">
                                        ...
                                        <div class="logo-barnd-img">
                                            <img class="img-fluid"
                                                 src="{{asset('new-user-side/images/brand-logo-5.png')}}" alt="img">
                                        </div>
                                    </li>
                                    <li class="all-brand-card">
                                        <div class="all-brand-img">
